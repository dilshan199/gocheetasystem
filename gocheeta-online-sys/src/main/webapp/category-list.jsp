...
<html>
	...
	<body>
		<div class="container-fluid page-table-content">
			<div class="row">
				...
				<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-2 page-table-inner-content">
					<div class="shadow-sm bg-white p-2">
						...
						<table class="table table-sm table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									<td><tag:out value="${category.catId}"></tag:out></td>
									<td>${category.category}</td>
									<td>
										<div class="dropdown">
											<button type="button" data-bs-toggle="dropdown" data-bs-target="#dropdownMenu" aria-expanded="false" class="btn btn-sm btn-outline-secondary dropdown-toggle">Action</button>
											<div class="dropdown-menu" id="dropdownMenu">
												<a href="edit?catId=<tag:out value='${category.catId}'></tag:out>" class="dropdown-item"><i class="bi bi-pencil-square"></i>&nbsp;Edit</a>
												<a href="delete?catId=<tag:out value='${category.catId}'></tag:out>" class="dropdown-item"><i class="bi bi-trash"></i>&nbsp;Delete</a>
											</div>
										</div>
									</td>
								</tr>
						...
						<tag:when test="${listSize == 0}">
							<div class="m-auto message-section">
									...
									<p class="text-center text-muted"><strong>No Records Found!</strong><br>Looks like you have no added any vehicle category.</p>
								</div>
						</tag:when>
						</tag:choose>
					</div>
