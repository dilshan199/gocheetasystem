...
Login checkUser = (Login) session.getAttribute("login");
if(checkUser == null){
	...
	<body>
		<div class="container-fluid filter">
			<div class="row">
				...
				<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-2 filter-result-table table-content">
					<div class="bg-white shadow-sm p-2">
						<tag:choose>
							<tag:when test="${listSize > 0}">
								<table class="table table-bordered table-sm table-striped">
									...
									<tbody>
										...
										<tr>
											<td colspan="7" class="text-end fw-bold">Total Sales(LKR)</td>
											<td class="fw-bold text-end"><tag:out value="${totalSales}"></tag:out></td>
										</tr>
									</tbody>
								</table>
							</tag:when>
							<tag:when test="${listSize == 0}">
								<div class="m-auto message-section">
									...
									<p class="text-center text-muted"><strong>No Filter Result Found!</strong><br>Try rewording your search or entering a new keyword.</p>
								</div>
							</tag:when>
						</tag:choose>
					</div>
