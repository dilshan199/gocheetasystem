			...
			<div class="row">
				...
				<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-2 form-content-inner">
					<div class="bg-white shadow-sm p-2">
						...
						<form action="branch?type=update" method="post">
							<div class="form-group row mb-2">
								<label for="branchName" class="col-10 col-sm-10 col-md-3 col-lg-3 col-xl-3">Branch <span class="text-danger">*</span></label>
								<label class="col-2 col-sm-2 col-md-1 col-lg-1 col-xl-1">:</label>
								<div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
									<input type="text" name="branchName" id="branchName" class="form-control form-control-sm" autocomplete="off" value="<tag:out value="${branch.branchName}"></tag:out>" />
									<input type="hidden" name="branchStatus" value="<tag:out value="${branch.branchStatus}"></tag:out>" />
									<input type="hidden" name="branchId" value="<tag:out value="${branch.branchId}"></tag:out>" />
									<span class="text-danger" style="font-size: 14px;font-weight: 400;"></span>
								</div>
							</div>
							<div class="offset-md-4 col-md-4">
								<button type="submit" name="submit" value="Update" class="btn btn-sm save-btn"><i class="bi bi-save"></i>&nbsp;Update</button>
							</div>
						</form>
					</div>
				</div>
