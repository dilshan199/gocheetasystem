...
<html>
	...
	<body>
		<div class="container-fluid mt-2 form-content">
			<div class="row">
				...
				<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-2 form-content-inner">
					<div class="bg-white p-2 shadow-sm">
						...
						<form action="category?type=submit" method="post">
							<div class="form-group row mb-2">
								<label for="category" class="form-label col-10 col-sm-10 col-md-3 col-lg-3 col-xl-3">Category <span class="text-danger">*</span></label>
								<label class="col-2 col-sm-2 col-md-1 col-lg-1 col-xl-1">:</label>
								<div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
									<input type="text" name="category" id="category" class="form-control form-control-sm" value="" autocomplete="off"/>
