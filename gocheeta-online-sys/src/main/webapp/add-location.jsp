	...
	<body>
		<div class="container-fluid form-content">
			<div class="row">
				...
				<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-2 form-inner">
					<div class="bg-white shadow-sm p-2">
						<tag:choose>
						...
						<tag:if test="${locationId == null}">
						<form action="newlocation?type=submit" method="post">
						</tag:if>
						<tag:if test="${locationId != null}">
						<form action="location?type=update" method="post">
						</tag:if>
								...
								<div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
									<select name="branchId" id="branchId" class="form-select form-select-sm">
										...
										<tag:forEach var="branch" items="${branchList}">
											<option value="<tag:out value='${branch.branchId}'></tag:out>" <tag:if test="${branch.branchId == location.branchId}">selected</tag:if> ><tag:out value="${branch.branchName}"></tag:out></option>
										</tag:forEach>
									</select>
							...
							<div class="form-group row mb-2">
								<label for="street" class="form-label col-10 col-sm-10 col-md-3 col-lg-3 col-xl-3">Street <span class="text-danger">*</span></label>
								<label class="col-2 col-sm-2 col-md-1 col-lg-1 col-xl-1">:</label>
								<div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
									<input type="text" name="street" id="street" autocomplete="off" class="form-control form-control-sm" value="<tag:if test='${locationId != null}'><tag:out value='${location.street}'></tag:out></tag:if>" />
									<span class="text-danger" style="font-size: 14px;font-weight: 400;"><tag:out value="${streetError}"></tag:out></span>
								</div>
							</div>
							<div class="form-group row mb-2">
								<label for="city" class="form-label col-10 col-sm-10 col-md-3 col-lg-3 col-xl-3">City <span class="text-danger">*</span></label>
								<label class="col-2 col-sm-2 col-md-1 col-lg-1 col-xl-1">:</label>
								<div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
									<input type="text" name="city" id="city" autocomplete="off" class="form-control form-control-sm" value="<tag:if test='${locationId != null}'><tag:out value='${location.city}'></tag:out></tag:if>" />
									<span class="text-danger" style="font-size: 14px;font-weight: 400;"><tag:out value="${cityError}"></tag:out></span>
								</div>
							</div>
							<div class="form-group row mb-2">
								<label for="distination" class="form-label col-10 col-sm-10 col-md-3 col-lg-3 col-xl-3">destination <span class="text-danger">*</span></label>
								<label class="col-2 col-sm-2 col-md-1 col-lg-1 col-xl-1">:</label>
								<div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
									<input type="text" name="distination" id="distination" autocomplete="off" class="form-control form-control-sm" value="<tag:if test='${locationId != null}'><tag:out value='${location.distination}'></tag:out></tag:if>" />
									<tag:if test="${locationId != null}">
										<input type="hidden" name="locationId" value="<tag:out value='${location.locationId}'></tag:out>" />
									</tag:if>
									<span class="text-danger" style="font-size: 14px;font-weight: 400;"><tag:out value="${distinationError}"></tag:out></span>
								</div>
							</div>
