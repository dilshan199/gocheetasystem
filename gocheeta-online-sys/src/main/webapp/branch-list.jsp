					...
					<div class="bg-white shadow-sm p-2">
						...
						<table class="table table-sm table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									<td><tag:out value="${branch.branchId}"></tag:out></td>
									<td><tag:out value="${branch.branchName}"></tag:out></td>
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu" id="actionMenu">
												<a href="branchEdit?branchId=<tag:out value='${branch.branchId}'></tag:out>" class="dropdown-item"><i class="bi bi-pencil-square"></i>&nbsp;Edit</a>
												<a href="branchDelete?branchId=<tag:out value='${branch.branchId}'></tag:out>" class="dropdown-item"><i class="bi bi-trash"></i>&nbsp;Delete</a>
											</div>
										</div>
									</td>
								</tr>
						...
						<tag:when test="${listSize == 0}">
							<div class="m-auto message-section">
								...
								<p class="text-center text-muted"><strong>No Records Found!</strong><br>Looks like you have no added any branches.</p>
							</div>
						</tag:when>
						</tag:choose>
					</div>
