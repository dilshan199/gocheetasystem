					...
					<div class="bg-white shadow-sm p-2">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mt-2" style="font-size: 15px;">
								...
								<li class="breadcrumb-item active" aria-current="page">Manage Driver</li>
							</ol>
						</nav>
					...
					<div class="bg-white shadow-sm p-2">
							...
							<table class="table table-sm table-bordered table-striped">
								...
								<tbody>
									<tag:forEach var="driver" items="${driverList}">
										<tr>
											<td><tag:out value="${driver.driverId}"></tag:out></td>
											<td><tag:out value="${driver.branchName}"></tag:out></td>
											<td><tag:out value="${driver.vehicleNo}"></tag:out></td>
											<td><tag:out value="${driver.firstName }"></tag:out> <tag:out value="${driver.lastName}"></tag:out></td>
											<td><tag:out value="${driver.nic}"></tag:out></td>
											<td>
												<tag:if test="${driver.driverStatus == 0}">
													<span class="badge bg-warning rounded-1">Free</span>
												</tag:if>
												<tag:if test="${driver.driverStatus == 1}">
													<span class="badge bg-success rounded-1">On Hire</span>
												</tag:if>
											</td>
											<td>
												<div class="dropdown">
													...
													<div class="dropdown-menu" id="actionBtn">
														<a href="driveredit?driverId=<tag:out value='${driver.driverId}'></tag:out>" class="dropdown-item" target="iframe"><i class="bi bi-pencil-square"></i>&nbsp;Edit</a>
														<a href="profile?driverId=<tag:out value='${driver.driverId}'></tag:out>" class="dropdown-item" target="iframe"><i class="bi bi-eye"></i>&nbsp;View Profile</a>
														<a href="driverdelete?driverId=<tag:out value='${driver.driverId}'></tag:out>" class="dropdown-item" target="iframe"><i class="bi bi-trash"></i>&nbsp;Delete</a>
													</div>
												</div>
											</td>
										</tr>
						...
						<tag:if test="${listSize == 0}">
							<div class="m-auto message-section">
								...
								<p class="text-center text-muted"><strong>No Records Found!</strong><br>Looks like you have no added new drivers.</p>
							</div>
						</tag:if>
					</div>
				</div>
