						...
						<tag:choose>
								...
								<table class="table table-sm table-bordered table-striped">
									...
									<tbody>
										<tag:forEach var="customer" items="${customerList}">
											<tr>
												<td><tag:out value="${customer.cId}"></tag:out></td>
												<td><tag:out value="${customer.fullName}"></tag:out></td>
												<td><tag:out value="${customer.contactNo}"></tag:out></td>
												<td><tag:out value="${customer.email}"></tag:out></td>
												<td>
													<div class="dropdown">
														...
														<div class="dropdown-menu" id="actionBtn">
															<a href="bookinglist?cId=<tag:out value='${customer.cId}'></tag:out>" class="dropdown-item" target="iframe"><i class="bi bi-list-check"></i>&nbsp;Booking List</a>
														</div>
													</div>
												</td>
											</tr>
							...
							<tag:when test="${listSize == 0}">
								<div class="m-auto message-section">
									...
									<p class="text-center text-muted"><strong>No Records Found!</strong><br>Looks like you have no added any customer register yet.</p>
								</div>
							</tag:when>
						</tag:choose>
					</div>
