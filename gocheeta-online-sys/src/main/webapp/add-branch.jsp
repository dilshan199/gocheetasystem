			...
			<div class="row">
				...
				<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mt-2 form-content-inner">
					<div class="p-2 bg-white shadow-sm">
						...
						<form action="branch?type=submit" method="post">
							<div class="form-group row mb-2">
								<label for="branch" class="form-label col-10 col-sm-10 col-md-3 col-lg-3 col-xl-3">Branch</label>
								<label class="col-2 col-sm-2 col-md-1 col-lg-1 col-xl-1">:</label>
								<div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
									<input type="text" name="branchName" id="branchName" class="form-control form-control-sm" value="" />
									<input type="hidden" name="branchStatus" id="branchStatus" value="0" />
									<span class="text-danger" style="font-size: 14px;font-weight: 400;"><tag:out value="${branchNameError}"></tag:out></span>
								</div>
							</div>
